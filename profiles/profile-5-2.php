...
<head>
    ...
    <link rel="canonical" href="https://geneticmatrix.com/learn/profiles/5/2/">
    ...
    <script type="application/ld+json">{"@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{"@type": "Question", "name": "What is a 5/2 Profile?", "acceptedAnswer": {"@type": "Answer", "text": "The 5/2 combines the Heretic (Line 5) with the Hermit (Line 2). They attract projections and expectations from others while needing solitude to develop their natural gifts. The rhythm of emergence and retreat defines their life."}}, {"@type": "Question", "name": "How do 5/2s manage the projection field?", "acceptedAnswer": {"@type": "Answer", "text": "By following Strategy and Authority to determine which callings to answer, and by honoring the 2nd line's need for retreat. Not every projection is correct - the 5/2 must be selective about when to emerge."}}, {"@type": "Question", "name": "Why do 5/2s withdraw?", "acceptedAnswer": {"@type": "Answer", "text": "The 2nd line (Hermit) needs solitude to integrate, recharge, and develop natural gifts. Without this retreat time, the 5/2 becomes depleted and cannot deliver on the 5th line projections."}}]}</script>
</head>
<body class="bg-white text-gray-700">
            ...
            <div class="flex flex-col lg:flex-row items-center gap-10 lg:gap-16">
                ...
                <div class="w-64 lg:w-72 flex-shrink-0">
                    <div class="bg-gm-darker/50 border-2 border-dashed border-gm-purple-light/30 rounded-xl flex items-center justify-center h-72">
                        <span class="text-gm-purple-light/50 text-sm font-semibold uppercase tracking-wide text-center px-4">Chart Image<br>Franz Schubert</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="py-10 md:py-14 bg-white">
        <div class="max-w-4xl mx-auto px-6">
            <div class="bg-gm-card-active rounded-2xl p-8 md:p-10">
                <p class="text-gm-text text-sm md:text-base leading-relaxed"><strong class="text-gray-800">Tools, not doctrine.</strong> Genetic Matrix provides these tools for your own exploration and experiment. The chart shown is Franz Schubert - Composer · Emotional Manifestor.</p>
            </div>
        </div>
    </section>
    ...
    <section class="py-10 md:py-14 bg-gm-light">
        <div class="max-w-4xl mx-auto px-6">
            <h2 class="text-xl md:text-2xl font-bold text-gray-800 mb-6">
                <span class="text-gm-purple">|</span> &#128300; What Is the 5/2 Profile?
            </h2>
            <p class="text-gm-text text-sm md:text-base leading-relaxed mb-4">The 5/2 Profile combines the <strong class="text-gray-800">Heretic</strong> (Line 5) with the <strong class="text-gray-800">Hermit</strong> (Line 2). This creates a compelling tension: the 5th line attracts projections and the world's attention, while the 2nd line needs solitude and prefers to be left alone. The 5/2 is called out into the world to deliver solutions, then retreats to recharge and develop their natural gifts.</p>
            <p class="text-gm-text text-sm md:text-base leading-relaxed mb-4">The conscious 5th line carries the <strong class="text-gray-800">projection field</strong> - others see practical solutions in the 5/2 and expect delivery. This projecting quality is unavoidable and powerful.</p>
            <p class="text-gm-text text-sm md:text-base leading-relaxed mb-4">The unconscious 2nd line carries <strong class="text-gray-800">natural talents</strong> that may not be consciously recognized. The Hermit needs withdrawal - time alone to integrate, develop, and simply be. The 2/5 tension is between being called out (5th line) and wanting to retreat (2nd line).</p>
        </div>
    </section>
    <!-- ==================== LIVING THE 5/2 ==================== -->
    <section class="py-10 md:py-14 bg-white">
        <div class="max-w-4xl mx-auto px-6">
            <h2 class="text-xl md:text-2xl font-bold text-gray-800 mb-6">
                <span class="text-gm-purple">|</span> &#127793; Living the 5/2
            </h2>
            <p class="text-gm-text text-sm md:text-base leading-relaxed mb-4">The 5/2 must learn the rhythm of <strong class="text-gray-800">emergence and retreat</strong>. They cannot stay in hermit mode forever - the 5th line projection will pull them out. But they cannot stay in the public eye indefinitely - the 2nd line will break down without solitude. The art is knowing when to emerge, deliver, and retreat. Strategy and Authority guide this rhythm.</p>
            ...
            <div class="bg-gm-card-active border-l-4 border-gm-purple rounded-r-lg p-5 my-6">
                ...
                <p class="text-gm-text text-sm leading-relaxed italic">Remember: your Profile operates within your Type and Authority. A 5/2 Generator lives this profile very differently from a 5/2 Projector. The Profile describes your role - your Type and Authority describe how you enter into that role correctly.</p>
            </div>
        </div>
    </section>
    ...
    <section class="py-10 md:py-14 bg-gm-light">
        <div class="max-w-4xl mx-auto px-6">
            <h2 class="text-xl md:text-2xl font-bold text-gray-800 mb-6">
                <span class="text-gm-purple">|</span> &#128149; The 5/2 in Relationships
            </h2>
            <p class="text-gm-text text-sm md:text-base leading-relaxed mb-4">In relationships, the 5/2 needs a partner who understands both the public projection (others always wanting something from the 5/2) and the private need for retreat. Space and solitude are non-negotiable, but so is the partner's ability to see the 5/2's natural gifts clearly.</p>
        </div>
    </section>
    ...
    <section class="py-10 md:py-14 bg-white">
        <div class="max-w-4xl mx-auto px-6">
            <h2 class="text-xl md:text-2xl font-bold text-gray-800 mb-6">
                <span class="text-gm-purple">|</span> &#127909; Watch: The 5/2 Profile
            </h2>
            <p class="text-gm-text text-sm md:text-base leading-relaxed mb-4">Explore the 5/2 Profile in motion - how the Heretic and Hermit lines interact, what it looks like in practice, and how to recognize this Profile in yourself and others.</p>
    ...
    <section class="py-10 md:py-14 bg-gm-light">
        <div class="max-w-4xl mx-auto px-6">
            <h2 class="text-xl md:text-2xl font-bold text-gray-800 mb-6">
                <span class="text-gm-purple">|</span> &#128640; How to Explore Your 5/2 Profile
            </h2>
            ...
            <p class="text-gm-text text-sm md:text-base leading-relaxed mb-4"><strong class="text-gray-800">The celebrity database:</strong> Explore other 5/2 Profiles in Genetic Matrix's 87,000+ celebrity database. See how the Heretic/Hermit dynamic manifests across different Types and life paths.</p>
        </div>
    </section>
    <!-- ==================== FAQ ACCORDION ==================== -->
    <section class="py-10 md:py-14 bg-gm-light">
        <div class="max-w-4xl mx-auto px-6">
            ...
            <div class="space-y-3">
                <details class="bg-white rounded-lg border border-gm-border">
                    ...
                    <div class="px-6 pb-4 text-sm text-gray-600 leading-relaxed">The 5/2 combines the Heretic (Line 5) with the Hermit (Line 2). They attract projections and expectations from others while needing solitude to develop their natural gifts. The rhythm of emergence and retreat defines their life.</div>
                </details>
                <details class="bg-white rounded-lg border border-gm-border">
                    <summary class="py-4 px-6 text-sm font-semibold text-gray-800">How do 5/2s manage the projection field?</summary>
                    <div class="px-6 pb-4 text-sm text-gray-600 leading-relaxed">By following Strategy and Authority to determine which callings to answer, and by honoring the 2nd line's need for retreat. Not every projection is correct - the 5/2 must be selective about when to emerge.</div>
                </details>
                <details class="bg-white rounded-lg border border-gm-border">
                    <summary class="py-4 px-6 text-sm font-semibold text-gray-800">Why do 5/2s withdraw?</summary>
                    <div class="px-6 pb-4 text-sm text-gray-600 leading-relaxed">The 2nd line (Hermit) needs solitude to integrate, recharge, and develop natural gifts. Without this retreat time, the 5/2 becomes depleted and cannot deliver on the 5th line projections.</div>
                </details>
            </div>
        </div>
    </section>
    ...
    <section class="py-8 bg-gm-light border-t border-gm-border">
        <div class="max-w-4xl mx-auto px-6 flex justify-between items-center">
            <a href="profile-5-1.php" class="flex items-center gap-2 text-gm-purple hover:text-gm-dark transition text-sm font-semibold">
