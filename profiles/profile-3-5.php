...
<body class="bg-white text-gray-700">
            ...
            <div class="flex flex-col lg:flex-row items-center gap-10 lg:gap-16">
                ...
                <div class="w-64 lg:w-72 flex-shrink-0">
                    <div class="bg-gm-darker/50 border-2 border-dashed border-gm-purple-light/30 rounded-xl flex items-center justify-center h-72">
                        <span class="text-gm-purple-light/50 text-sm font-semibold uppercase tracking-wide text-center px-4">Chart Image<br>Ju Wenjun</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="py-10 md:py-14 bg-gm-light">
        <div class="max-w-4xl mx-auto px-6">
            <h2 class="text-xl md:text-2xl font-bold text-gray-800 mb-6">
                <span class="text-gm-purple">|</span> &#128640; How to Explore Your 3/5 Profile
            </h2>
            ...
            <p class="text-gm-text text-sm md:text-base leading-relaxed mb-4"><strong class="text-gray-800">The celebrity database:</strong> Explore other 3/5 Profiles in Genetic Matrix's 87,000+ celebrity database. See how the Martyr/Heretic dynamic manifests across different Types and life paths.</p>
        </div>
    </section>
    <!-- ==================== FAQ ACCORDION ==================== -->
    <section class="py-10 md:py-14 bg-gm-light">
