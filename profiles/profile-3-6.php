...
<head>
    ...
    <meta name="description" content="The experiential learner who becomes a wise example. 3/6s live through chaos in the first phase and emerge as role models who embody lived wisdom.">
    <link rel="canonical" href="https://geneticmatrix.com/learn/profiles/3/6/">
    ...
    <script type="application/ld+json">{"@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{"@type": "Question", "name": "What is a 3/6 Profile?", "acceptedAnswer": {"@type": "Answer", "text": "The 3/6 combines the Martyr (Line 3) with the Role Model (Line 6). They live through three phases: chaotic experimentation (~0-30), observation from the roof (~30-50), and stepping into role model energy (~50+). Their wisdom is earned through lived experience."}}, {"@type": "Question", "name": "Why is the first 30 years so chaotic for 3/6s?", "acceptedAnswer": {"@type": "Answer", "text": "In Phase 1, both lines operate as 3rd line energy - pure trial and error. This double-3 experience is intensely experimental. Bonds made and broken, paths tried and abandoned. This chaos builds the lived wisdom that will eventually make them authentic role models."}}, {"@type": "Question", "name": "What does 'going on the roof' mean?", "acceptedAnswer": {"@type": "Answer", "text": "Around age 30, the 6th line shifts from experiential mode to observer mode. The 3/6 steps back, gains perspective, reflects on lessons learned. They become more selective and discerning while the 3rd line continues its experimental process."}}]}</script>
</head>
<body class="bg-white text-gray-700">
        ...
        <div class="max-w-5xl mx-auto px-6">
            <div class="flex flex-col lg:flex-row items-center gap-10 lg:gap-16">
                <div class="flex-1 text-center lg:text-left">
                    ...
                    <p class="text-gray-400 text-sm md:text-base leading-relaxed max-w-xl mb-6">The experiential learner who becomes a wise example. 3/6s live through chaos in the first phase and emerge as role models who embody lived wisdom.</p>
                ...
                <div class="w-64 lg:w-72 flex-shrink-0">
                    <div class="bg-gm-darker/50 border-2 border-dashed border-gm-purple-light/30 rounded-xl flex items-center justify-center h-72">
                        <span class="text-gm-purple-light/50 text-sm font-semibold uppercase tracking-wide text-center px-4">Chart Image<br>Wolfgang Pauli</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="py-10 md:py-14 bg-white">
        <div class="max-w-4xl mx-auto px-6">
            <div class="bg-gm-card-active rounded-2xl p-8 md:p-10">
                <p class="text-gm-text text-sm md:text-base leading-relaxed"><strong class="text-gray-800">Tools, not doctrine.</strong> Genetic Matrix provides these tools for your own exploration and experiment. The chart shown is Wolfgang Pauli - Physicist · Heart Manifestor.</p>
            </div>
        </div>
    </section>
    ...
    <section class="py-10 md:py-14 bg-gm-light">
        <div class="max-w-4xl mx-auto px-6">
            <h2 class="text-xl md:text-2xl font-bold text-gray-800 mb-6">
                <span class="text-gm-purple">|</span> &#128300; What Is the 3/6 Profile?
            </h2>
            <p class="text-gm-text text-sm md:text-base leading-relaxed mb-4">The 3/6 Profile combines the <strong class="text-gray-800">Martyr</strong> (Line 3) with the <strong class="text-gray-800">Role Model</strong> (Line 6) - creating one of the most transformative profiles in Human Design. The 3/6 lives through three distinct life phases, each fundamentally different from the last.</p>
            <p class="text-gm-text text-sm md:text-base leading-relaxed mb-4"><strong class="text-gray-800">Phase 1 (Birth to ~30):</strong> The 3/6 lives as a double 3rd line - pure trial and error, experimentation, bonds made and broken. This phase can be intensely chaotic. Both lines are operating through the 3rd line energy, making this the most experimental period of the 3/6's life.</p>
            <p class="text-gm-text text-sm md:text-base leading-relaxed mb-4"><strong class="text-gray-800">Phase 2 (~30 to ~50):</strong> The 6th line "goes on the roof." The 3/6 steps back from the chaos and begins to observe, reflect, and integrate the wisdom gained from Phase 1. They become more selective, more discerning. The experimentation continues through the 3rd line, but the 6th line provides a higher perspective.</p>
            <p class="text-gm-text text-sm md:text-base leading-relaxed mb-4"><strong class="text-gray-800">Phase 3 (~50+):</strong> The 6th line "comes off the roof." The 3/6 steps into their role model energy - not through theory, but through deeply lived experience. They become the wise example, embodying the lessons of a life fully lived.</p>
        </div>
    </section>
    <!-- ==================== LIVING THE 3/6 ==================== -->
    <section class="py-10 md:py-14 bg-white">
        <div class="max-w-4xl mx-auto px-6">
            <h2 class="text-xl md:text-2xl font-bold text-gray-800 mb-6">
                <span class="text-gm-purple">|</span> &#127793; Living the 3/6
            </h2>
            <p class="text-gm-text text-sm md:text-base leading-relaxed mb-4">The 3/6's journey requires <strong class="text-gray-800">patience and trust in the process</strong>. The chaos of Phase 1 is building the foundation for the wisdom of Phase 3. Nothing is wasted. Every failed experiment, every broken bond, every painful lesson becomes part of the lived wisdom that makes the 3/6 an authentic role model.</p>
            ...
            <div class="bg-gm-card-active border-l-4 border-gm-purple rounded-r-lg p-5 my-6">
                ...
                <p class="text-gm-text text-sm leading-relaxed italic">Remember: your Profile operates within your Type and Authority. A 3/6 Generator lives this profile very differently from a 3/6 Projector. The Profile describes your role - your Type and Authority describe how you enter into that role correctly.</p>
            </div>
        </div>
    </section>
    ...
    <section class="py-10 md:py-14 bg-gm-light">
        <div class="max-w-4xl mx-auto px-6">
            <h2 class="text-xl md:text-2xl font-bold text-gray-800 mb-6">
                <span class="text-gm-purple">|</span> &#128149; The 3/6 in Relationships
            </h2>
            <p class="text-gm-text text-sm md:text-base leading-relaxed mb-4">In Phase 1, relationships may be tumultuous - the double 3rd line energy creates rapid trial and error. In Phase 2, the 3/6 becomes more observant and selective. In Phase 3, relationships carry the depth of lived experience and authentic wisdom.</p>
        </div>
    </section>
    ...
    <section class="py-10 md:py-14 bg-white">
        <div class="max-w-4xl mx-auto px-6">
            <h2 class="text-xl md:text-2xl font-bold text-gray-800 mb-6">
                <span class="text-gm-purple">|</span> &#127909; Watch: The 3/6 Profile
            </h2>
            <p class="text-gm-text text-sm md:text-base leading-relaxed mb-4">Explore the 3/6 Profile in motion - how the Martyr and Role Model lines interact, what it looks like in practice, and how to recognize this Profile in yourself and others.</p>
    ...
    <section class="py-10 md:py-14 bg-gm-light">
        <div class="max-w-4xl mx-auto px-6">
            <h2 class="text-xl md:text-2xl font-bold text-gray-800 mb-6">
                <span class="text-gm-purple">|</span> &#128640; How to Explore Your 3/6 Profile
            </h2>
            ...
            <p class="text-gm-text text-sm md:text-base leading-relaxed mb-4"><strong class="text-gray-800">The celebrity database:</strong> Explore other 3/6 Profiles in Genetic Matrix's 87,000+ celebrity database. See how the Martyr/Role Model dynamic manifests across different Types and life paths.</p>
        </div>
    </section>
    <!-- ==================== FAQ ACCORDION ==================== -->
    <section class="py-10 md:py-14 bg-gm-light">
        <div class="max-w-4xl mx-auto px-6">
            ...
            <div class="space-y-3">
                <details class="bg-white rounded-lg border border-gm-border">
                    ...
                    <div class="px-6 pb-4 text-sm text-gray-600 leading-relaxed">The 3/6 combines the Martyr (Line 3) with the Role Model (Line 6). They live through three phases: chaotic experimentation (~0-30), observation from the roof (~30-50), and stepping into role model energy (~50+). Their wisdom is earned through lived experience.</div>
                </details>
                <details class="bg-white rounded-lg border border-gm-border">
                    <summary class="py-4 px-6 text-sm font-semibold text-gray-800">Why is the first 30 years so chaotic for 3/6s?</summary>
                    <div class="px-6 pb-4 text-sm text-gray-600 leading-relaxed">In Phase 1, both lines operate as 3rd line energy - pure trial and error. This double-3 experience is intensely experimental. Bonds made and broken, paths tried and abandoned. This chaos builds the lived wisdom that will eventually make them authentic role models.</div>
                </details>
                <details class="bg-white rounded-lg border border-gm-border">
                    <summary class="py-4 px-6 text-sm font-semibold text-gray-800">What does 'going on the roof' mean?</summary>
                    <div class="px-6 pb-4 text-sm text-gray-600 leading-relaxed">Around age 30, the 6th line shifts from experiential mode to observer mode. The 3/6 steps back, gains perspective, reflects on lessons learned. They become more selective and discerning while the 3rd line continues its experimental process.</div>
                </details>
            </div>
        </div>
    </section>
    ...
    <section class="py-10 md:py-14 bg-white">
        <div class="max-w-4xl mx-auto px-6">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                ...
                <a href="profile-4-1.php" class="bg-gm-light rounded-lg border border-gm-border p-4 hover:shadow-md transition">
                    <h3 class="text-sm font-bold text-gm-purple mb-1">4/1 Opportunist / Investigator →</h3>
                    <p class="text-gray-400 text-xs leading-relaxed">The networker with deep foundational knowledge. 4/1s influence through relations...</p>
                </a>
    ...
    <section class="py-8 bg-gm-light border-t border-gm-border">
        <div class="max-w-4xl mx-auto px-6 flex justify-between items-center">
            ...
            <a href="profile-4-6.php" class="flex items-center gap-2 text-gm-purple hover:text-gm-dark transition text-sm font-semibold">
