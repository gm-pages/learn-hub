...
<script src="https://cdn.tailwindcss.com"></script>
 ...
 "@type": "Article",
 "headline": "1/3 Profile in Human Design - Investigator / Martyr",
 "description": "The deep researcher who learns through trial and error. 1/3s build foundations of knowledge and then test everything through direct experience.",
 "publisher": {
 "@type": "Organization",
 "name": "Genetic Matrix",
 "url": "https://www.geneticmatrix.com"
 },
 "mainEntityOfPage": "https://www.geneticmatrix.com/learn-hub/profiles/profile-1-3.php",
 "datePublished": "2025-01-15",
 "dateModified": "2026-03-06"
 }
 </script>
 <script type="application/ld+json">{"@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{"@type": "Question", "name": "What is a 1/3 Profile?", "acceptedAnswer": {"@type": "Answer", "text": "The 1/3 combines the Investigator, Line 1, with the third-line trial-and-error process. The conscious 1st line drives deep research and foundation-building, while the unconscious 3rd line learns through direct experience. Together, they create someone who needs both understanding and real-world testing."}}, {"@type": "Question", "name": "Why do 1/3s seem to fail so much?", "acceptedAnswer": {"@type": "Answer", "text": "The 3rd line learns through trial and error. What looks like failure is often part of the discovery process. Each experiment that does not work narrows down what does. Over time, 1/3s build extraordinary wisdom through these experiences."}}, {"@type": "Question", "name": "How do 1/3s approach relationships?", "acceptedAnswer": {"@type": "Answer", "text": "Usually with investigation first and experimentation second. The 1st line wants to understand the other person deeply, while the 3rd line needs to experience the relationship directly. Bonds may be formed, tested, and sometimes broken as part of that process."}}, {"@type": "Question", "name": "Do 1/3s need to research everything?", "acceptedAnswer": {"@type": "Answer", "text": "Often, yes. The 1st line needs a strong foundation before it feels secure, so 1/3s naturally ask questions, dig deeper, and want to understand what they are getting into. For them, research is not just curiosity. It is part of building confidence before experience takes over."}}]}</script>
</head>
...
<!-- ==================== BREADCRUMB ==================== -->
 ...
 <span class="inline-block bg-gm-purple text-white text-xs font-semibold tracking-widest uppercase px-4 py-1.5 rounded-full mb-4">Profile 1/3</span>
 <h1 class="text-3xl md:text-4xl font-bold mb-2">1/3 Profile</h1>
 <p class="text-gm-purple-light text-lg font-medium mb-3">Investigator / Martyr</p>
 <p class="text-gray-400 text-sm md:text-base leading-relaxed max-w-xl mb-6">The deep researcher who learns through trial and error. 1/3s build foundations of knowledge and then test everything through direct experience.</p>
 ...
 <img src="/learn-hub/profiles/images/1-3-HG-Wells.png" alt="1/3 Profile Bodygraph chart for H.G. Wells" class="rounded-xl w-full h-auto">
 </div>
 </div>
 </div>
 </section>
...
What Is the 1/3 Profile?
 ...
 <p class="text-gm-text text-sm md:text-base leading-relaxed mb-4">The 1/3 Profile combines the <strong class="text-gray-800">Investigator</strong>, Line 1, with a third-line trial-and-error learning style, creating a person who needs to understand things deeply and then verify that understanding through direct experience. These are people who do not take things at face value. They need to research, study, and then test what they learn in the real world.</p>
 <p class="text-gm-text text-sm md:text-base leading-relaxed mb-4">The conscious first line drives a deep need for <strong class="text-gray-800">security through knowledge</strong>. Before a 1/3 can feel comfortable with anything, whether a relationship, a career, or a belief system, they need to investigate it thoroughly. They ask questions, dig into foundations, and want to feel that what they are standing on is solid.</p>
 <p class="text-gm-text text-sm md:text-base leading-relaxed mb-4">The unconscious third line adds an experimental dimension. No amount of research fully satisfies this part of the profile, because it learns by <strong class="text-gray-800">trying things and discovering what works through experience</strong>. Bonds are made and broken. Jobs are started and left. Experiments are run, and many of them fail. This is not dysfunction. It is part of the 1/3 process. Each experience helps build the grounded understanding that the first line is looking for.</p>
 </div>
 </section>
...
How the 1 and 3 Work Together
 ...
 <p class="text-gm-text text-sm md:text-base leading-relaxed mb-4">The 1/3 Profile brings together two very different but complementary forces. Line 1 wants a solid foundation. It needs to investigate, research, and understand how things work before it feels secure. Line 3, by contrast, learns through direct experience. It discovers what is true by testing, adjusting, and sometimes finding out the hard way what does not hold up.</p>
 <p class="text-gm-text text-sm md:text-base leading-relaxed mb-4">This creates the core tension of the 1/3. Part of you wants certainty before moving forward, while another part can only gain real confidence by getting involved and learning through trial and error. You may study something deeply, form a careful understanding, and then still need to test it in real life before it becomes truly yours.</p>
 <p class="text-gm-text text-sm md:text-base leading-relaxed mb-4">When these two lines work well together, the result is <strong class="text-gray-800">practical wisdom</strong>. The 1 gives depth, rigor, and a need for strong foundations. The 3 brings adaptability, resilience, and real-world proof. Together, they create someone who does not just collect knowledge, but tests it through lived experience.</p>
 <p class="text-gm-text text-sm md:text-base leading-relaxed mb-4">That is why the 1/3 often grows through a cycle of research, experimentation, correction, and deeper understanding. What can feel disruptive in the moment is often the very process that builds grounded self-trust over time.</p>
 </div>
 </section>
 <!-- ==================== LIVING THE 1/3 ==================== -->
 <section class="py-10 md:py-14 bg-gm-light">
...
Living the 1/3
 ...
 <p class="text-gm-text text-sm md:text-base leading-relaxed mb-4">The 1/3 life can feel chaotic from the outside, always researching, always experimenting, always breaking things to see how they work. But from the inside, there is a clear logic: <strong class="text-gray-800">understand it deeply, then test it in practice</strong>. The failures are not setbacks. They are data. Every broken bond, every abandoned project, and every experiment that does not work adds to the 1/3's extraordinary depth of knowledge.</p>
 <p class="text-gm-text text-sm md:text-base leading-relaxed mb-4">The key for 1/3s is <strong class="text-gray-800">not to take the failures personally</strong>. The third-line process is impersonal. It is the mechanics of discovery through experience. When a 1/3 can embrace the trial-and-error process without shame, life becomes an extraordinary laboratory of wisdom.</p>
 ...
 <p class="text-gm-text text-sm leading-relaxed italic">Your Profile does not operate in isolation. It works within your Type and Authority. A 1/3 Generator lives this profile differently from a 1/3 Projector. The Profile describes your role, while your Type and Authority describe how you enter into that role correctly.</p>
 </div>
 </div>
 </section>
...
The 1/3 in Relationships
 ...
 <p class="text-gm-text text-sm md:text-base leading-relaxed mb-4">Before a 1/3 makes a move, there is often a stealth phase. They are quietly watching, noticing patterns, and trying to understand the other person before stepping forward. Most of this happens invisibly. The other person may not even realize how closely they are being observed.</p>
...
Watch: The 1/3 Profile
 ...
 <p class="text-gm-text text-sm md:text-base leading-relaxed mb-4">See the 1/3 Profile in motion. This short animated video explores how the Investigator and third-line trial-and-error process work together, what this profile looks like in practice, and how to recognize it in yourself and others.</p>
 <p class="text-gm-text text-sm md:text-base leading-relaxed mb-4">Below is a 3 minute animated video about the 1/3 Profile from our YouTube channel.</p>

 <div class="relative w-full pt-[56.25%] mt-6 rounded-xl overflow-hidden">
 <iframe src="https://www.youtube.com/embed/mAY58YCkSUo" title="Watch: The 1/3 Profile" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen class="absolute top-0 left-0 w-full h-full"></iframe>
 </div>
 </div>
 </section>
 <!-- ==================== HOW TO EXPLORE YOUR 1/3 PROFILE ==================== -->
 <section class="py-10 md:py-14 bg-white">
 <div class="max-w-4xl mx-auto px-6">
 <h2 class="text-xl md:text-2xl font-bold text-gray-800 mb-6">
...
Frequently Asked Questions
 ...
 <summary class="py-4 px-6 text-sm font-semibold text-gray-800">What is a 1/3 Profile?</summary>
 <div class="px-6 pb-4 text-sm text-gray-600 leading-relaxed">The 1/3 combines the Investigator, Line 1, with the third-line trial-and-error process. The conscious 1st line drives deep research and foundation-building, while the unconscious 3rd line learns through direct experience. Together, they create someone who needs both understanding and real-world testing.</div>
 </details>
 <details class="bg-white rounded-lg border border-gm-border">
 <summary class="py-4 px-6 text-sm font-semibold text-gray-800">Why do 1/3s seem to fail so much?</summary>
 <div class="px-6 pb-4 text-sm text-gray-600 leading-relaxed">The 3rd line learns through trial and error. What looks like failure is often part of the discovery process. Each experiment that does not work narrows down what does. Over time, 1/3s build extraordinary wisdom through these experiences.</div>
 </details>
 <details class="bg-white rounded-lg border border-gm-border">
 <summary class="py-4 px-6 text-sm font-semibold text-gray-800">How do 1/3s approach relationships?</summary>
 <div class="px-6 pb-4 text-sm text-gray-600 leading-relaxed">Usually with investigation first and experimentation second. The 1st line wants to understand the other person deeply, while the 3rd line needs to experience the relationship directly. Bonds may be formed, tested, and sometimes broken as part of that process.</div>
 </details>
 <details class="bg-white rounded-lg border border-gm-border">
 <summary class="py-4 px-6 text-sm font-semibold text-gray-800">Do 1/3s need to research everything?</summary>
 <div class="px-6 pb-4 text-sm text-gray-600 leading-relaxed">Often, yes. The 1st line needs a strong foundation before it feels secure, so 1/3s naturally ask questions, dig deeper, and want to understand what they are getting into. For them, research is not just curiosity. It is part of building confidence before experience takes over.</div>
 </details>
 </div>
 </div>
 </section>
