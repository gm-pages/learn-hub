 ...
 <p class="text-gray-600 text-xs leading-relaxed">Stable foundation with influence through trusted relationships and community.</p>
    ...
    <section class="py-8 bg-gm-light border-t border-gm-border">
        <div class="max-w-4xl mx-auto px-6 flex justify-between items-center gap-3">
            <a href="profile-1-3.php" class="flex items-center gap-2 text-gm-purple hover:text-gm-dark transition text-xs md:text-sm font-semibold">
            ...
            <a href="profile-2-4.php" class="flex items-center gap-2 text-gm-purple hover:text-gm-dark transition text-xs md:text-sm font-semibold">
