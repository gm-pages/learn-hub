        ...
        <div class="max-w-[1400px] mx-auto px-6 flex items-center justify-between h-[80px]">
            ...
            <div class="hidden lg:flex items-center gap-6">
                ...
                <a href="https://www.geneticmatrix.com/cart/" title="Cart" class="relative">
                    ...
                    <span id="gm-cart-count" class="absolute inset-0 flex items-center justify-center text-gm-green font-bold text-[11px] hidden">0</span>
                </a>
                <!-- Language -->
            ...
            <a href="https://www.geneticmatrix.com/cart/" title="Cart" class="lg:hidden relative">
                <img src="/learn-hub/assets/icon-cart.svg" alt="Cart" class="h-5 w-auto">
                <span id="gm-cart-count-mobile" class="absolute inset-0 flex items-center justify-center text-gm-green font-bold text-[11px] hidden">0</span>
            </a>
        </div>
