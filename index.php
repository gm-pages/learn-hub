    ...
    <!-- ==================== NAV BAR ==================== -->
        ...
        <div class="w-full px-[30px] flex items-center h-[80px]">
            ...
            <div class="lg:hidden flex items-center gap-4">
                <a href="https://www.geneticmatrix.com/cart/" title="Cart" class="px-2 relative">
            ...
            <!-- Desktop Nav -->
            <div class="hidden lg:flex items-center ml-auto gap-0">
                <!-- Calendar -->
                <a href="https://www.geneticmatrix.com/calendar/" class="px-2 flex items-center justify-center w-9 h-9 rounded-lg border border-[#dee2e6] hover:border-gm-purple/30 hover:bg-gray-50 transition" title="Calendar">
                    <img src="/learn-hub/assets/icon-calendar.svg" alt="Calendar" class="h-5 w-5">
                </a>
                <!-- Reports -->
                <a href="https://www.geneticmatrix.com/geneticmatrix-reports/" class="px-2 flex items-center justify-center w-9 h-9 rounded-lg border border-[#dee2e6] hover:border-gm-purple/30 hover:bg-gray-50 transition" title="Reports">
                    <img src="/learn-hub/assets/icon-report.svg" alt="Reports" class="h-6 w-6">
                </a>
                <!-- Talking Charts -->
                <a href="https://www.geneticmatrix.com/talking-charts/" class="px-2 flex items-center justify-center w-9 h-9 rounded-lg border border-[#dee2e6] hover:border-gm-purple/30 hover:bg-gray-50 transition" title="Talking Charts">
                    <img src="/learn-hub/assets/icon-talking-chart.svg" alt="Talking Charts" class="h-5 w-5">
                </a>
                <!-- Free Chart -->
                <a href="#" class="px-2 text-gm-gray hover:text-gray-900 text-sm font-medium" data-action="free-chart-popup">Free Chart</a>
                <!-- Learn Dropdown -->
                <div class="relative group">
                    <button class="px-2 text-gm-purple hover:text-gm-dark text-sm font-semibold flex items-center gap-1">
                        Learn
                ...
                <!-- Our Plans -->
                <a href="https://www.geneticmatrix.com/plans-features/" class="px-2 text-gm-gray hover:text-gray-900 text-sm font-medium">Our Plans</a>
                <!-- Cart -->
                <a href="https://www.geneticmatrix.com/cart/" title="Cart" class="px-2 relative">
                    <img src="/learn-hub/assets/icon-cart.svg" alt="Cart" class="h-5 w-auto">
                ...
                <!-- Language -->
                <div class="px-2 flex items-center gap-1 text-gm-gray text-sm">
                    <span>English</span>
                    <img src="/learn-hub/assets/icon-english.svg" alt="English" class="h-5 w-7">
                </div>
                <!-- Logged OUT -->
                <div id="gm-logged-out" class="flex items-center gap-4">
                    <a href="https://www.geneticmatrix.com/my-account/" class="px-2 text-gm-gray hover:text-gray-900 text-sm font-medium">Sign In</a>
                ...
                <div id="gm-logged-in" class="hidden items-center gap-4">
                    <a href="https://www.geneticmatrix.com/wp-login.php?action=logout&redirect_to=%2Flogout-1%2F" class="px-2 text-gm-gray hover:text-gray-900 text-sm font-medium">Log Out</a>
