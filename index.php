    ...
    <nav class="bg-white border-b border-gray-200 sticky top-0 z-50">
        <div class="max-w-[1400px] mx-auto px-6 flex items-center justify-between h-[80px]">
            ...
            <div class="flex items-center gap-8">
                <!-- Report Icon -->
                <a href="https://www.geneticmatrix.com/geneticmatrix-reports/" class="hidden md:flex items-center justify-center w-9 h-9 rounded-lg border border-gray-200 hover:border-gm-purple/30 hover:bg-gray-50 transition" title="Reports">
                    <img src="assets/icon-report.svg" alt="Reports" class="h-6 w-6">
                </a>
                <!-- Talking Chart Icon -->
                <a href="https://www.geneticmatrix.com/talking-charts/" class="hidden md:flex items-center justify-center w-9 h-9 rounded-lg border border-gray-200 hover:border-gm-purple/30 hover:bg-gray-50 transition" title="Talking Charts">
