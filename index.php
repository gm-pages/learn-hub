    ...
    <div class="max-w-[1400px] mx-auto px-[30px] flex items-center h-[80px]">
        ...
        <div class="hidden lg:flex items-center gap-4">
            ...
            <!-- Language Switcher -->
                ...
                <a href="/wp-login.php?action=logout&redirect_to=%2F" class="gm-logged-in-only text-gm-gray hover:text-gray-900 text-xl font-medium transition whitespace-nowrap" style="display:none">Log Out</a>
    ...
    <div id="gm-mobile-menu" style="display:none" class="lg:hidden bg-white border-t border-gray-100 px-6 py-4">
        <div class="flex flex-col gap-3">
            <!-- Auth block FIRST so returning users don't hunt for Sign In (2026-05-29) -->
                ...
                <a href="/wp-login.php?action=logout&redirect_to=%2F" class="gm-logged-in-only py-2 text-sm text-gm-gray hover:text-gray-900 transition" style="display:none">Log Out</a>
