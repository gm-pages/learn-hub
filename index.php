...
<body class="bg-white text-gray-700">
    ...
    <nav class="bg-white border-b border-gray-200 sticky top-0 z-50">
        <div class="max-w-[1400px] mx-auto px-6 flex items-center justify-between h-[60px] md:h-[60px] md:h-[80px]">
            <!-- Logo -->
            ...
            <div class="flex items-center gap-8">
                ...
                <a href="https://www.geneticmatrix.com/calendar/" class="hidden md:flex items-center justify-center w-9 h-9 rounded-lg border border-[#dee2e6] hover:border-gm-purple/30 hover:bg-gray-50 transition" title="Calendar">
                    <img src="../assets/icon-calendar.svg" alt="Calendar" class="h-5 w-5">
                </a>
                <a href="https://www.geneticmatrix.com/geneticmatrix-reports/" class="hidden md:flex items-center justify-center w-9 h-9 rounded-lg border border-[#dee2e6] hover:border-gm-purple/30 hover:bg-gray-50 transition" title="Reports">
                    <img src="assets/icon-report.svg" alt="Reports" class="h-6 w-6">
                </a>
                <!-- Talking Chart Icon -->
                <a href="https://www.geneticmatrix.com/talking-charts/" class="hidden md:flex items-center justify-center w-9 h-9 rounded-lg border border-[#dee2e6] hover:border-gm-purple/30 hover:bg-gray-50 transition" title="Talking Charts">
                    <img src="assets/icon-talking-chart.svg" alt="Talking Charts" class="h-5 w-5">
                </a>
                        ...
                        <div class="grid grid-cols-2 gap-1">
                            <a href="/learn-hub/" class="flex items-start gap-3 p-1 rounded-lg hover:bg-gm-light transition">
                                ...
                                <div>
                                    ...
                                    <div class="text-xs text-gm-text-light mt-0.5">HD and Astrology education</div>
                                </div>
                            </a>
                            <a href="/learn-hub/celebrities/" class="flex items-start gap-3 p-1 rounded-lg hover:bg-gm-light transition">
                                ...
                                <div>
                                    ...
                                    <div class="text-xs text-gm-text-light mt-0.5">88,600+ celebrity charts</div>
                                </div>
                            </a>
                            <a href="/dictionary/dictionary.html" class="flex items-start gap-3 p-1 rounded-lg hover:bg-gm-light transition">
                                ...
                                <div>
                                    ...
                                    <div class="text-xs text-gm-text-light mt-0.5">HD and Astrology terms</div>
                                </div>
                            </a>
                        </div>
                    </div>
                ...
                <a href="https://www.geneticmatrix.com/cart/" title="Cart" class="relative">
                    <img src="assets/icon-cart.svg" alt="Cart" class="h-5 w-auto">
                ...
                <div class="hidden md:flex items-center gap-1 text-gm-gray text-sm">
                    ...
                    <img src="assets/icon-english.svg" alt="English" class="h-5 w-7">
                                ...
                                <!-- Logged OUT state -->
                <div id="gm-logged-out" class="hidden lg:flex items-center gap-4">
                    <a href="https://www.geneticmatrix.com/my-account/" class="hidden md:block text-gm-gray hover:text-gray-900 text-sm font-medium">Sign In</a>
                ...
                <div id="gm-logged-in" class="hidden lg:hidden items-center gap-4">
...
<script id="gm-hamburger-script">document.addEventListener("DOMContentLoaded",function(){var h=document.getElementById("gm-hamburger");var m=document.getElementById("gm-mobile-menu");if(h&&m){h.addEventListener("click",function(){m.classList.toggle("hidden");});}});</script>
