                        ...
                        <div class="grid grid-cols-2 gap-1">
                            <a href="/learn-hub/" class="flex items-start gap-3 p-1 rounded-lg hover:bg-gm-light transition">
                                <div class="w-9 h-9 bg-gm-card-active rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5">
                                    <img src="../assets/Menu_Icon_ Hub.svg" alt="Learn Hub" class="w-5 h-5">
                                </div>
                                <div>
                            ...
                            <a href="/learn-hub/celebrities/" class="flex items-start gap-3 p-1 rounded-lg hover:bg-gm-light transition">
                                <div class="w-9 h-9 bg-gm-card-active rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5">
                                    <img src="../assets/Menu_Icon _celebrity .svg" alt="Celebrity Search" class="w-5 h-5">
                                </div>
                                <div>
                            ...
                            <a href="/dictionary/dictionary.html" class="flex items-start gap-3 p-1 rounded-lg hover:bg-gm-light transition">
                                <div class="w-9 h-9 bg-gm-card-active rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5">
                                    <img src="../assets/Menu_Icon_ dictionary.svg" alt="Dictionary" class="w-5 h-5">
                                </div>
                                <div>
