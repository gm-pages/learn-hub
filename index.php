...
<script id="gm-lang-redirect">(function(){
  ...
  if (cookieLang && SUPPORTED.indexOf(cookieLang) !== -1 && cookieLang !== "en") {
    ...
    <style>
        ...
        /* Calc method icon color tints (base SVG color is #6e5898 purple) */
        .icon-tint-teal { filter: brightness(0) saturate(100%) invert(58%) sepia(52%) saturate(450%) hue-rotate(127deg) brightness(92%) contrast(89%); }
        .icon-tint-red { filter: brightness(0) saturate(100%) invert(33%) sepia(60%) saturate(1200%) hue-rotate(336deg) brightness(90%) contrast(90%); }
        .icon-tint-pink { filter: brightness(0) saturate(100%) invert(52%) sepia(40%) saturate(600%) hue-rotate(290deg) brightness(95%) contrast(90%); }
        .icon-tint-navy { filter: brightness(0) saturate(100%) invert(30%) sepia(30%) saturate(800%) hue-rotate(190deg) brightness(95%) contrast(95%); }
            ...
            <div class="relative group">
                ...
                <div class="absolute top-full left-1/2 -translate-x-1/2 pt-4 w-[320px] bg-white rounded-xl shadow-xl border border-gray-100 p-3 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                    <div class="flex flex-col gap-1">
                        <a href="https://www.geneticmatrix.com/geneticmatrix-reports/" class="flex items-start gap-3 p-2 rounded-lg hover:bg-gm-light transition">
                            <div class="w-7 h-7 bg-gm-card-active rounded-md flex items-center justify-center flex-shrink-0 mt-0.5"><img src="https://www.geneticmatrix.com/wp-content/themes/geneticmatrix/assets/icons/report%20icon%20(2).svg" alt="" class="w-5 h-5"></div>
                        ...
                        <a href="https://www.geneticmatrix.com/talking-charts/" class="flex items-start gap-3 p-2 rounded-lg hover:bg-gm-light transition">
                            <div class="w-7 h-7 bg-gm-card-active rounded-md flex items-center justify-center flex-shrink-0 mt-0.5"><img src="https://www.geneticmatrix.com/wp-content/themes/geneticmatrix/assets/icons/GM%20Icon%20Talking%20Chart.svg" alt="" class="w-5 h-5"></div>
                            <div><div class="text-sm font-semibold text-gray-800">Talking Charts</div><div class="text-xs text-gm-text-light mt-0.5">Audio interpretations for your chart</div></div>
                                                ...
                                                <a href="https://www.geneticmatrix.com/free-foundation-chart/" class="flex items-start gap-3 p-2 rounded-lg hover:bg-gm-light transition gm-logged-out-only">
                    ...
                    <div class="grid grid-cols-2 gap-1">
                        ...
                        <a href="/learn-hub/dictionary/dictionary.html" class="flex items-start gap-3 p-2 rounded-lg hover:bg-gm-light transition">
                            ...
                            <div><div class="flex items-center gap-1.5"><span class="text-sm font-semibold text-gray-800">Dictionary</span><span class="text-[10px] font-semibold text-gm-green bg-gm-green/10 px-1.5 py-0.5 rounded-full">Free</span></div><div class="text-xs text-gm-text-light mt-0.5">Every HD and Astrology term explained</div></div>
                                                ...
                                                <a href="https://www.geneticmatrix.com/astro-calendar/?lang=en" class="flex items-start gap-3 p-2 rounded-lg hover:bg-gm-light transition">
                            <div class="w-7 h-7 bg-gm-card-active rounded-md flex items-center justify-center flex-shrink-0 mt-0.5"><img src="https://www.geneticmatrix.com/wp-content/themes/geneticmatrix/assets/icon-transits.svg" alt="" class="w-6 h-6"></div>
                            <div><div class="flex items-center gap-1.5"><span class="text-sm font-semibold text-gray-800">Astro Calendar</span><span class="text-[10px] font-semibold text-gm-green bg-gm-green/10 px-1.5 py-0.5 rounded-full">Free</span></div><div class="text-xs text-gm-text-light mt-0.5">Daily transits across Western, Vedic, and Human Design</div></div>
                        </a>
                    </div>
                </div>
            </div>
            <a href="https://www.geneticmatrix.com/plans-features/" class="text-gm-gray hover:text-gray-900 text-xl font-medium transition whitespace-nowrap">Our Plans</a>
            <!-- Language Switcher -->
                <div class="relative group px-3">
                    ...
                    <div class="absolute top-full left-0 mt-4 w-44 bg-white rounded-xl shadow-xl border border-gray-100 py-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                        ...
                        <a data-lang="pt" href="https://www.geneticmatrix.com/pt-pt/" class="flex items-center gap-3 px-4 py-2 text-sm text-gm-gray hover:bg-gm-light hover:text-gm-purple transition"><span class="flag-icon flag-icon-pt"></span> Português</a>
                            
                        <a data-lang="nl" href="https://www.geneticmatrix.com/nl/" class="flex items-center gap-3 px-4 py-2 text-sm text-gm-gray hover:bg-gm-light hover:text-gm-purple transition"><span class="flag-icon flag-icon-nl"></span> Nederlands</a>
                            
                        <a data-lang="it" href="https://www.geneticmatrix.com/it/" class="flex items-center gap-3 px-4 py-2 text-sm text-gm-gray hover:bg-gm-light hover:text-gm-purple transition"><span class="flag-icon flag-icon-it"></span> Italiano</a>
                            
                        <a data-lang="fr" href="https://www.geneticmatrix.com/fr/" class="flex items-center gap-3 px-4 py-2 text-sm text-gm-gray hover:bg-gm-light hover:text-gm-purple transition"><span class="flag-icon flag-icon-fr"></span> Français</a>
                            
                        <a data-lang="es" href="https://www.geneticmatrix.com/es/" class="flex items-center gap-3 px-4 py-2 text-sm text-gm-gray hover:bg-gm-light hover:text-gm-purple transition"><span class="flag-icon flag-icon-es"></span> Español</a>
                            
                        <a data-lang="de" href="https://www.geneticmatrix.com/de/" class="flex items-center gap-3 px-4 py-2 text-sm text-gm-gray hover:bg-gm-light hover:text-gm-purple transition"><span class="flag-icon flag-icon-de"></span> Deutsch</a>
                            
                        <a data-lang="en" href="https://www.geneticmatrix.com/" class="flex items-center gap-3 px-4 py-2 text-sm text-gm-gray hover:bg-gm-light hover:text-gm-purple transition"><span class="flag-icon flag-icon-gb"></span> English</a>
                                             </div>
                </div>
                                                    <a href="https://www.geneticmatrix.com/login/" class="text-gm-gray hover:text-gray-900 text-xl font-medium transition whitespace-nowrap gm-logged-out-only">Sign In</a>
                <a href="https://www.geneticmatrix.com/register/" class="bg-gm-green hover:bg-gm-green-dark text-white text-base font-semibold px-5 py-2 rounded-full transition cursor-pointer gm-logged-out-only">Sign Up</a>
                <a href="https://www.geneticmatrix.com/cart/"
                ...
                <a href="https://www.geneticmatrix.com/wp-login.php?action=logout&redirect_to=%2Flogout-1%2F" class="gm-logged-in-only text-gm-gray hover:text-gray-900 text-xl font-medium transition whitespace-nowrap" style="display:none">Log Out</a>
                <a href="https://www.geneticmatrix.com/user-home/" class="gm-logged-in-only bg-gm-green hover:bg-gm-green-dark text-white text-base font-semibold px-5 py-2 rounded-full transition" style="display:none">My Hub</a>
    ...
    <div id="gm-mobile-menu" style="display:none" class="lg:hidden bg-white border-t border-gray-100 px-6 py-4">
        <div class="flex flex-col gap-3">
            <!-- Auth block FIRST so returning users don't hunt for Sign In (2026-05-29) -->
                            <a href="https://www.geneticmatrix.com/register/" class="inline-block bg-gm-green text-white text-sm font-semibold px-5 py-2 rounded-full transition text-center cursor-pointer gm-logged-out-only">Sign Up</a>
                <a href="https://www.geneticmatrix.com/login/" class="py-2 text-sm text-gm-gray hover:text-gray-900 transition gm-logged-out-only">Sign In</a>
                <a href="https://www.geneticmatrix.com/user-home/" class="gm-logged-in-only inline-block bg-gm-green text-white text-sm font-semibold px-5 py-2 rounded-full transition text-center" style="display:none">My Hub</a>
                <a href="https://www.geneticmatrix.com/wp-login.php?action=logout&redirect_to=%2Flogout-1%2F" class="gm-logged-in-only py-2 text-sm text-gm-gray hover:text-gray-900 transition" style="display:none">Log Out</a>

                        <div class="border-t border-gray-100 my-1"></div>
            <a href="https://www.geneticmatrix.com/geneticmatrix-reports/" class="py-2 text-sm text-gm-gray hover:text-gray-900 transition">Reports</a>
            <a href="https://www.geneticmatrix.com/talking-charts/" class="py-2 text-sm text-gm-gray hover:text-gray-900 transition">Talking Charts</a>
                        <a href="https://www.geneticmatrix.com/free-foundation-chart/" class="py-2 text-sm text-gm-gray hover:text-gray-900 transition gm-logged-out-only">Free Chart</a>
                                    <div class="border-t border-gray-100 my-1"></div>
            ...
            <a href="https://www.geneticmatrix.com/astro-calendar/?lang=en" class="py-2 text-sm font-semibold text-gray-800 hover:text-gm-purple transition flex items-center gap-1.5">Astro Calendar<span class="text-[10px] font-semibold text-gm-green bg-gm-green/10 px-1.5 py-0.5 rounded-full">Free</span></a>
...
<!-- ==================== HERO / PAGE HEADER ==================== -->
    ...
    <section class="bg-gm-light py-12 md:py-16">
        <div class="max-w-6xl mx-auto px-6">
            ...
            <h2 class="text-xl md:text-2xl font-bold text-gray-800 mb-3">
                <span class="text-gm-purple">|</span> Human Design Tools & Resources
            </h2>
            <p class="text-gray-500 text-sm md:text-base max-w-3xl mb-10">
                Explore the mechanics of your design - from basic core body elements to the deepest layers of cognitive differentiation.
            </p>

            <!-- Foundation Basics Sub-header -->
            <h3 class="text-base md:text-lg font-semibold text-gray-700 mb-5">Foundation Basics</h3>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div class="flex items-start gap-4 mb-4 flex-1">
                        ...
                        <div>
                            ...
                            <p class="text-gray-500 text-sm leading-relaxed">
                                Human Design System works primarily through your Bodygraph. It divides all of us into five Types: Generator, Manifesting Generator, Projector, Manifestor, and Reflector.
                            </p>
                        </div>
                    </div>
                ...
                <div class="card-reveal card-link bg-white rounded-lg border border-gm-border p-6 hover:shadow-md hover:-translate-y-1 hover:border-gray-300 hover:bg-[#F5F3F8] transition-all duration-300 flex flex-col">
                    <div class="flex items-start gap-4 mb-4 flex-1">
                        ...
                        <div>
                            ...
                            <p class="text-gray-500 text-sm leading-relaxed">
                                Your Profile describes 70% of the behavioral costume that you embody and display as a signpost to correctly living your role of purpose.
                            </p>
                        </div>
                    </div>
                ...
                <div class="card-reveal card-link bg-white rounded-lg border border-gm-border p-6 hover:shadow-md hover:-translate-y-1 hover:border-gray-300 hover:bg-[#F5F3F8] transition-all duration-300 flex flex-col">
                    <div class="flex items-start gap-4 mb-4 flex-1">
                        <img src="assets/icon-rhombus.svg" alt="Centers" class="w-16 h-16 flex-shrink-0">
                        <div>
                ...
                <div class="card-reveal card-link bg-white rounded-lg border border-gm-border p-6 hover:shadow-md hover:-translate-y-1 hover:border-gray-300 hover:bg-[#F5F3F8] transition-all duration-300 flex flex-col">
                    <div class="flex items-start gap-4 mb-4 flex-1">
                        ...
                        <div>
                            ...
                            <p class="text-gray-500 text-sm leading-relaxed">
                                The 36 Channels connect Centers and create definition in your Bodygraph. Each Channel is formed by two Gates and carries a specific energy theme that shapes how you experience life and impact others through conditioning.
                            </p>
                        </div>
                    </div>
                ...
                <div class="card-reveal card-link bg-white rounded-lg border border-gm-border p-6 hover:shadow-md hover:-translate-y-1 hover:border-gray-300 hover:bg-[#F5F3F8] transition-all duration-300 flex flex-col">
                    <div class="flex items-start gap-4 mb-4 flex-1">
                        ...
                        <div>
                            ...
                            <p class="text-gray-500 text-sm leading-relaxed">
                                Gates and Lines are the specific archetypal energies activated in your chart by planetary positions. There are 64 Gates in the Bodygraph, each with 6 Lines, derived from the 64 hexagrams of the I Ching.
                            </p>
                        </div>
                    </div>
                ...
                <div class="card-reveal card-link bg-white rounded-lg border border-gm-border p-6 hover:shadow-md hover:-translate-y-1 hover:border-gray-300 hover:bg-[#F5F3F8] transition-all duration-300 flex flex-col">
                    <div class="flex items-start gap-4 mb-4 flex-1">
                        ...
                        <div>
                            ...
                            <p class="text-gray-500 text-sm leading-relaxed">
                                Channels, Gates and Lines group into three overarching Circuit families - Individual, Collective, and Tribal. Individual and Tribal circuits further sub-divide into Knowing, Integration, Centering, Ego and Defense circuits.
                            </p>
                        </div>
                    </div>
                ...
                <div class="card-reveal card-link bg-white rounded-lg border border-gm-border p-6 hover:shadow-md hover:-translate-y-1 hover:border-gray-300 hover:bg-[#F5F3F8] transition-all duration-300 flex flex-col">
                    <div class="flex items-start gap-4 mb-4 flex-1">
                        ...
                        <div>
                            ...
                            <p class="text-gray-500 text-sm leading-relaxed">
                                Definition describes how your defined Centers connect to each other. Single, Split, Triple Split, Quadruple Split, or No Definition - each Definition type shapes how you process energy and relate to others.
                            </p>
                        </div>
                    </div>
                ...
                <div class="card-reveal card-link bg-white rounded-lg border border-gm-border p-6 hover:shadow-md hover:-translate-y-1 hover:border-gray-300 hover:bg-[#F5F3F8] transition-all duration-300 flex flex-col">
                    <div class="flex items-start gap-4 mb-4 flex-1">
                        <img src="assets/icon-planets.svg" alt="HD Planets" class="w-16 h-16 flex-shrink-0">
                        <div>
                            <h3 class="text-lg font-bold text-gray-800 mb-1">Planets</h3>
                            <p class="text-gray-500 text-sm leading-relaxed">
                                In Human Design, each planet programs specific Gates and Lines in your Bodygraph. Learn how the Sun, Moon, Nodes, and planets carry different meanings than in traditional astrology.
                            </p>
                        </div>
                    </div>
                    <a href="astrology/planets.html#planets-in-human-design" class="text-gm-purple text-sm font-semibold hover:underline mt-auto card-link-target">Explore →</a>
                </div>

                <!-- Incarnation Cross Card -->
                <div class="card-reveal card-link bg-white rounded-lg border border-gm-border p-6 hover:shadow-md hover:-translate-y-1 hover:border-gray-300 hover:bg-[#F5F3F8] transition-all duration-300 flex flex-col">
                    <div class="flex items-start gap-4 mb-4 flex-1">
                        <img src="assets/icon-incarnation.svg" alt="Incarnation Cross" class="w-16 h-16 flex-shrink-0">
                        <div>
                            <h3 class="text-lg font-bold text-gray-800 mb-1">Incarnation Cross</h3>
                            <p class="text-gray-500 text-sm leading-relaxed">
                                Your Incarnation Cross is defined by four Gate and Line activations and provides the overarching theme through which your purpose may emerge. Crosses are grouped into Quarters and Cross types.
                            </p>
                        </div>
                    </div>
                    <a href="incarnation-cross/index.html" class="text-gm-purple text-sm font-semibold hover:underline mt-auto card-link-target">Explore →</a>
                </div>

            </div>

            <!-- Advanced Topics Sub-header -->
            <h3 class="text-base md:text-lg font-semibold text-gray-700 mt-10 mb-5">Advanced Topics</h3>

            <!-- Advanced Cards Grid -->
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">

                <!-- Deeper Mechanics Card -->
                <div class="card-reveal card-link bg-white rounded-lg border border-gm-border p-6 hover:shadow-md hover:-translate-y-1 hover:border-gray-300 hover:bg-[#F5F3F8] transition-all duration-300 flex flex-col">
                    <div class="flex items-start gap-4 mb-4 flex-1">
                        <img src="assets/icon-deeper-mechanics.svg" alt="Deeper Mechanics" class="w-16 h-16 flex-shrink-0">
                        <div>
                            <h3 class="text-lg font-bold text-gray-800 mb-1">Deeper Mechanics</h3>
                            <p class="text-gray-500 text-sm leading-relaxed">
                                Determination, Environment, Perspective, and Motivation. The four critical areas for living your design correctly at the deepest level.
                            </p>
                        </div>
                    </div>
                    <a href="deeper-mechanics/index.html" class="text-gm-purple text-sm font-semibold hover:underline mt-auto card-link-target">Explore →</a>
                </div>

                <!-- Variables & Arrows Card -->
                <div class="card-reveal card-link bg-white rounded-lg border border-gm-border p-6 hover:shadow-md hover:-translate-y-1 hover:border-gray-300 hover:bg-[#F5F3F8] transition-all duration-300 flex flex-col">
                    <div class="flex items-start gap-4 mb-4 flex-1">
                        <img src="assets/icon-arrows.svg" alt="Variable Arrows" class="w-16 h-16 flex-shrink-0">
                        <div>
                            <h3 class="text-lg font-bold text-gray-800 mb-1">Variable Arrows</h3>
                            <p class="text-gray-500 text-sm leading-relaxed">
                                The four arrows at the top of your Bodygraph reveal your Variables, which are Tone derived and represent the deepest level of quantum differentiation in Human Design.
                            </p>
                        </div>
                    </div>
                ...
                <div class="card-reveal card-link bg-white rounded-lg border border-gm-border p-6 hover:shadow-md hover:-translate-y-1 hover:border-gray-300 hover:bg-[#F5F3F8] transition-all duration-300 flex flex-col">
                    <div class="flex items-start gap-4 mb-4 flex-1">
                        ...
                        <div>
                            ...
                            <p class="text-gray-500 text-sm leading-relaxed">
                                When you sleep, your entire design changes and reverts to a 5 centered design. Explore how this functions and affects your rest and regeneration.
                            </p>
                        </div>
                    </div>
                ...
                <div class="card-reveal card-link bg-white rounded-lg border border-gm-border p-6 hover:shadow-md hover:-translate-y-1 hover:border-gray-300 hover:bg-[#F5F3F8] transition-all duration-300 flex flex-col">
                    <div class="flex items-start gap-4 mb-4 flex-1">
                        <img src="assets/icon-paw.svg" alt="Animal Design" class="w-16 h-16 flex-shrink-0">
                        <div>
                            <h3 class="text-lg font-bold text-gray-800 mb-1">Animal Design</h3>
                            <p class="text-gray-500 text-sm leading-relaxed">
                                Animals carry their own unique design and energetic blueprint. Mammals, reptiles, birds, fish, insects and arachnids can also specifically condition and be conditioned by humans.
                            </p>
                        </div>
                    </div>
                ...
                <div class="card-reveal card-link bg-white rounded-lg border border-gm-border p-6 hover:shadow-md hover:-translate-y-1 hover:border-gray-300 hover:bg-[#F5F3F8] transition-all duration-300 flex flex-col">
                    <div class="flex items-start gap-4 mb-4 flex-1">
                        <img src="assets/icon-cycles.svg" alt="Life Cycles" class="w-16 h-16 flex-shrink-0">
                        <div>
                            <h3 class="text-lg font-bold text-gray-800 mb-1">Life Cycles</h3>
                            <p class="text-gray-500 text-sm leading-relaxed">
                                Saturn Return, Uranus Opposition, and Chiron Return mark critical maturation and transformation phases in life. Other cycles like Solar Return, Lunar, Jupiter and others have specific conditioning value and impact.
                            </p>
                        </div>
                    </div>
                    <a href="cycles/index.html" class="text-gm-purple text-sm font-semibold hover:underline mt-auto card-link-target">Explore →</a>
                </div>

                <!-- Transits Card -->
                <div class="card-reveal card-link bg-white rounded-lg border border-gm-border p-6 hover:shadow-md hover:-translate-y-1 hover:border-gray-300 hover:bg-[#F5F3F8] transition-all duration-300 flex flex-col">
                    <div class="flex items-start gap-4 mb-4 flex-1">
                        <img src="assets/icon-transits.svg" alt="Transits" class="w-16 h-16 flex-shrink-0">
                        <div>
                            <h3 class="text-lg font-bold text-gray-800 mb-1">Transits</h3>
                            <p class="text-gray-500 text-sm leading-relaxed">
                                The neutrino stream carries planetary programming that conditions everyone in realtime, whether awake or asleep. The transiting planets activate Gates and Lines in your chart, revealing another deep conditioning layer impacting your mind.
                            </p>
                        </div>
                    </div>
                    <a href="transits/index.html" class="text-gm-purple text-sm font-semibold hover:underline mt-auto card-link-target">Explore →</a>
                </div>

                <!-- Connection Chart Card -->
                <div class="card-reveal card-link bg-white rounded-lg border border-gm-border p-6 hover:shadow-md hover:-translate-y-1 hover:border-gray-300 hover:bg-[#F5F3F8] transition-all duration-300 flex flex-col">
                    <div class="flex items-start gap-4 mb-4 flex-1">
                        <img src="assets/icon-connection.svg" alt="Connection Chart" class="w-16 h-16 flex-shrink-0">
                        <div>
                            <h3 class="text-lg font-bold text-gray-800 mb-1">Connection Chart</h3>
                            <p class="text-gray-500 text-sm leading-relaxed">
                                A Connection design consumes individual designs and reveals the mechanics of a union. The Connection design reveals that a union is more than the sum of its parts.
                            </p>
                        </div>
                    </div>
                    <a href="connection/index.html" class="text-gm-purple text-sm font-semibold hover:underline mt-auto card-link-target">Explore →</a>
                </div>

                <!-- Family Penta Card -->
                <div class="card-reveal card-link bg-white rounded-lg border border-gm-border p-6 hover:shadow-md hover:-translate-y-1 hover:border-gray-300 hover:bg-[#F5F3F8] transition-all duration-300 flex flex-col">
                    <div class="flex items-start gap-4 mb-4 flex-1">
                        <img src="assets/icon-penta.svg" alt="Family Penta" class="w-16 h-16 flex-shrink-0">
                        <div>
                            <h3 class="text-lg font-bold text-gray-800 mb-1">Family Penta</h3>
                            <p class="text-gray-500 text-sm leading-relaxed">
                                The Penta is a transpersonal energetic form that emerges when groups of 3 to 5 people are within auric contact. It has its own mechanics. In terms of the family unit, Penta themes dominate how a family unit functions.
                            </p>
                        </div>
                    </div>
                    <a href="penta/index.html" class="text-gm-purple text-sm font-semibold hover:underline mt-auto card-link-target">Explore →</a>
                </div>

                <!-- Business Penta (BG5) Card -->
                <div class="card-reveal card-link bg-white rounded-lg border border-gm-border p-6 hover:shadow-md hover:-translate-y-1 hover:border-gray-300 hover:bg-[#F5F3F8] transition-all duration-300 flex flex-col">
                    <div class="flex items-start gap-4 mb-4 flex-1">
                        <img src="assets/icon-penta.svg" alt="Business Penta (BG5)" class="w-16 h-16 flex-shrink-0">
                        <div>
                            <h3 class="text-lg font-bold text-gray-800 mb-1">Business Penta (BG5)</h3>
                            <p class="text-gray-500 text-sm leading-relaxed">
                                The Business Penta is the same Penta mechanics applied to small business teams. The only difference is the terminology, relabeled for a business context.
                            </p>
                        </div>
                    </div>
                    <a href="bg5/index.html" class="text-gm-purple text-sm font-semibold hover:underline mt-auto card-link-target">Explore →</a>
                </div>

                <!-- OC16 (WA) Card -->
                <div class="card-reveal card-link bg-white rounded-lg border border-gm-border p-6 hover:shadow-md hover:-translate-y-1 hover:border-gray-300 hover:bg-[#F5F3F8] transition-all duration-300 flex flex-col">
                    <div class="flex items-start gap-4 mb-4 flex-1">
                        <img src="assets/icon-oc16.svg" alt="WA (OC16)" class="w-16 h-16 flex-shrink-0">
                        <div>
                            <h3 class="text-lg font-bold text-gray-800 mb-1">WA (OC16)</h3>
                            <p class="text-gray-500 text-sm leading-relaxed">
                                The WA is a trans-auric form emerging from the combined energy field of nine or more people. The OC16 are the 6 core channels (and 10 sub-channels) the WA uses to condition individuals to function as specific 'cogs' serving the whole.
                            </p>
                        </div>
                    </div>
                    <a href="oc16/index.html" class="text-gm-purple text-sm font-semibold hover:underline mt-auto card-link-target">Explore →</a>
                </div>

                <!-- Homo Solaris Card -->
                <div class="card-reveal card-link bg-white rounded-lg border border-gm-border p-6 hover:shadow-md hover:-translate-y-1 hover:border-gray-300 hover:bg-[#F5F3F8] transition-all duration-300 flex flex-col">
                    <div class="flex items-start gap-4 mb-4 flex-1">
                        <img src="assets/icon-homo-solaris.svg" alt="Homo Solaris" class="w-16 h-16 flex-shrink-0">
                        <div>
                            <h3 class="text-lg font-bold text-gray-800 mb-1">Homo Solaris</h3>
                            <p class="text-gray-500 text-sm leading-relaxed">
                                Homo Solaris is the new species emerging from the Solar Plexus Mutation beginning February 2027. Defined by quad-right architecture and shared consciousness, Homo Solaris represents the next evolutionary step for humanity.
                            </p>
                        </div>
                    </div>
                    <a href="homo-solaris/index.html" class="text-gm-purple text-sm font-semibold hover:underline mt-auto card-link-target">Explore →</a>
                </div>
    ...
    <section class="bg-white py-12 md:py-16">
        <div class="max-w-6xl mx-auto px-6">
            <!-- Section Header -->
            <div class="mb-2">
                <span class="text-xs font-semibold tracking-widest text-gray-400 uppercase">Calculation Methods</span>
            </div>
            <h2 class="text-xl md:text-2xl font-bold text-gray-800 mb-3">
            ...
            <p class="text-gray-500 text-sm md:text-base max-w-4xl mb-10">
                Genetic Matrix offers multiple calculation systems that each produce a valid chart - explore the differences and decide what resonates with you.
            </p>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <!-- Tropical Card -->
                <div class="card-reveal card-link bg-gm-light rounded-lg border border-gm-border p-6 hover:shadow-lg hover:-translate-y-2 hover:bg-white transition-all duration-300 border-t-4 border-t-gm-purple flex flex-col">
                    <div class="flex items-start gap-4 mb-4 flex-1">
                        <img src="assets/icon-centres.svg" alt="Tropical" class="w-16 h-16 flex-shrink-0">
                        <div>
                            <span class="text-xs font-semibold tracking-widest text-gm-purple uppercase">Tropical</span>
                            <h3 class="text-lg font-bold text-gray-800 mb-1">Tropical Zodiac</h3>
                            <p class="text-gray-500 text-sm leading-relaxed">
                                The standard system specified by Ra Uru Hu for Human Design. Based on the seasons and the vernal equinox, this is the most widely used system in Western astrology.
                            </p>
                        </div>
                    </div>
                ...
                <div class="card-reveal card-link bg-gm-light rounded-lg border border-gm-border p-6 hover:shadow-lg hover:-translate-y-2 hover:bg-white transition-all duration-300 border-t-4 border-t-gm-pink flex flex-col">
                    <div class="flex items-start gap-4 mb-4 flex-1">
                        <img src="assets/icon-j2k.svg" alt="J2000" class="w-20 h-20 flex-shrink-0 -ml-2">
                        <div>
                            ...
                            <p class="text-gray-500 text-sm leading-relaxed">
                                A standard celestial reference frame that freezes the mean equator and equinox at 12:00 Terrestrial Time on January 1, 2000. Removes Precession and Nutation.
                            </p>
                        </div>
                    </div>
                ...
                <div class="card-reveal card-link bg-gm-light rounded-lg border border-gm-border p-6 hover:shadow-lg hover:-translate-y-2 hover:bg-white transition-all duration-300 border-t-4 border-t-[#2ea89e] flex flex-col">
                    <div class="flex items-start gap-4 mb-4 flex-1">
                        <img src="assets/icon-windrose.svg" alt="Sidereal" class="w-16 h-16 flex-shrink-0 icon-tint-teal">
                        <div>
                            ...
                            <p class="text-gray-500 text-sm leading-relaxed">
                                Unlike the tropical zodiac, sidereal systems measure time or motion based on the position of the Earth relative to the distant, "fixed" stars, rather than relative to the Sun. To account for the Earth's precession of the equinoxes, Ayanamshas are used ensuring that the zodiac signs align with the actual, fixed constellations in the sky.
                            </p>
                        </div>
                    </div>
                ...
                <div class="card-reveal card-link bg-gm-light rounded-lg border border-gm-border p-6 hover:shadow-lg hover:-translate-y-2 hover:bg-white transition-all duration-300 border-t-4 border-t-[#c94040] flex flex-col">
                    <div class="flex items-start gap-4 mb-4 flex-1">
                        <img src="assets/icon-dragon.svg" alt="Draconic" class="w-16 h-16 flex-shrink-0 icon-tint-red">
                        <div>
                            ...
                            <p class="text-gray-500 text-sm leading-relaxed">
                                The Draconic system shifts the entire tropical zodiac so the North Node becomes 0° Aries. It reveals a soul-level chart connected to your karmic path.
                            </p>
                        </div>
                    </div>
                ...
                <div class="card-reveal card-link bg-gm-light rounded-lg border border-gm-border p-6 hover:shadow-lg hover:-translate-y-2 hover:bg-white transition-all duration-300 border-t-4 border-t-[#d46ba3] flex flex-col">
                    <div class="flex items-start gap-4 mb-4 flex-1">
                        <img src="assets/icon-star.svg" alt="True Sidereal" class="w-16 h-16 flex-shrink-0 icon-tint-pink">
                        <div>
                            ...
                            <p class="text-gray-500 text-sm leading-relaxed">
                                True Sidereal astrology does not use a traditional, fixed Indian ayanamsa like Lahiri. Instead, it aligns with the actual, visible boundaries of the constellations. Popularized by Clementi and Kanatas using the IAU boundary system, while others use a Midpoint system. Genetic Matrix supports all of these methods.
                            </p>
                        </div>
                    </div>
                ...
                <div class="card-reveal card-link bg-gm-light rounded-lg border border-gm-border p-6 hover:shadow-lg hover:-translate-y-2 hover:bg-white transition-all duration-300 border-t-4 border-t-[#3d5a96] flex flex-col">
                    <div class="flex items-start gap-4 mb-4 flex-1">
                        <img src="assets/icon-ophiuchus.svg" alt="13-Sign Sidereal" class="w-16 h-16 flex-shrink-0 icon-tint-navy">
                        <div>
                            <span class="text-xs font-semibold tracking-widest text-[#3d5a96] uppercase">True Sidereal</span>
                            <h3 class="text-lg font-bold text-gray-800 mb-1">13-Sign True Sidereal</h3>
                            <p class="text-gray-500 text-sm leading-relaxed">
                                13-Sign True Sidereal recognizes that the Sun passes through 13 constellations, including Ophiuchus (situated between Scorpio and Sagittarius), making the signs unequal in size. Scorpio is notably tiny with this method.
                            </p>
                        </div>
                    </div>
                ...
                <!-- Hybrid Calculation Card -->
                <div class="card-reveal card-link bg-gm-light rounded-lg border border-gm-border p-6 hover:shadow-lg hover:-translate-y-2 hover:bg-white transition-all duration-300 border-t-4 border-t-[#e8961d] flex flex-col">
                    <div class="flex items-start gap-4 mb-4 flex-1">
                        <img src="assets/icon-circuits.svg" alt="Hybrid" class="w-16 h-16 flex-shrink-0">
                        <div>
                            <span class="text-xs font-semibold tracking-widest text-[#e8961d] uppercase">Hybrid</span>
                            <h3 class="text-lg font-bold text-gray-800 mb-1">Hybrid Calculation</h3>
                            <p class="text-gray-500 text-sm leading-relaxed">
                                The best of both worlds for sidereal enthusiasts. Combines real-sky sidereal positions with Tropical-derived Human Design elements like Planets, Gates and Lines. This is unique to Genetic Matrix.
                            </p>
                        </div>
                    </div>
    ...
    <section class="bg-gm-light py-8 md:py-10">
        <div class="max-w-6xl mx-auto px-6">
            ...
            <h3 class="text-base md:text-lg font-semibold text-gray-700 mb-5">Core Astrology</h3>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="card-reveal card-link bg-white rounded-lg border border-gm-border p-6 hover:shadow-md hover:-translate-y-1 hover:border-gray-300 hover:bg-[#F5F3F8] transition-all duration-300 flex flex-col">
                    <div class="flex items-start gap-4 mb-4 flex-1">
                        ...
                        <div>
                            ...
                            <p class="text-gray-500 text-sm leading-relaxed">
                                The 12 Zodiac signs - plus the controversial True Sidereal 13th sign Ophiuchus. Explore each sign's element, modality, ruling planet, and core characteristics.
                            </p>
                        </div>
                    </div>
                ...
                <div class="card-reveal card-link bg-white rounded-lg border border-gm-border p-6 hover:shadow-md hover:-translate-y-1 hover:border-gray-300 hover:bg-[#F5F3F8] transition-all duration-300 flex flex-col">
                    <div class="flex items-start gap-4 mb-4 flex-1">
                        ...
                        <div>
                            <h3 class="text-lg font-bold text-gray-800 mb-1">Planets</h3>
                            <p class="text-gray-500 text-sm leading-relaxed">
                                From the Sun through personal planets like Mercury and Mars to outer planets like Pluto, understand what each celestial body represents in your birth chart.
                            </p>
                        </div>
                    </div>
                ...
                <div class="card-reveal card-link bg-white rounded-lg border border-gm-border p-6 hover:shadow-md hover:-translate-y-1 hover:border-gray-300 hover:bg-[#F5F3F8] transition-all duration-300 flex flex-col">
                    <div class="flex items-start gap-4 mb-4 flex-1">
                        ...
                        <div>
                            ...
                            <p class="text-gray-500 text-sm leading-relaxed">
                                The 12 houses represent the specific areas or "stages" of life where different energies (planets) play out, acting as a map for your daily experiences and developmental themes. There are over a dozen recognised house systems all supported by Genetic Matrix - from Placidus and Koch to Whole Sign and Equal.
                            </p>
                        </div>
                    </div>
                ...
                <div class="card-reveal card-link bg-white rounded-lg border border-gm-border p-6 hover:shadow-md hover:-translate-y-1 hover:border-gray-300 hover:bg-[#F5F3F8] transition-all duration-300 flex flex-col">
                    <div class="flex items-start gap-4 mb-4 flex-1">
                        ...
                        <div>
                            ...
                            <p class="text-gray-500 text-sm leading-relaxed">
                                Aspects in astrology represent the geometric angles and relationships between planets. They reveal how planetary energies interact, influencing personality dynamics, potentials, and challenges through specific angular distances, such as 0°, 90°, or 120°.
                            </p>
                        </div>
                    </div>
                ...
                <div class="card-reveal card-link bg-white rounded-lg border border-gm-border p-6 hover:shadow-md hover:-translate-y-1 hover:border-gray-300 hover:bg-[#F5F3F8] transition-all duration-300 flex flex-col">
                    <div class="flex items-start gap-4 mb-4 flex-1">
                        ...
                        <div>
                            ...
                            <p class="text-gray-500 text-sm leading-relaxed">
                                Asteroids and Planetoids (eg Ceres) act as "messengers" or archetypal influencers, often linked to mythology, that provide deeper insights into relationships, personality, and life events. Common Asteroids and Planetoids include Ceres (nurturing), Pallas (wisdom), Juno (partnership), and Vesta (devotion).
                            </p>
                        </div>
                    </div>
                ...
                <div class="card-reveal card-link bg-white rounded-lg border border-gm-border p-6 hover:shadow-md hover:-translate-y-1 hover:border-gray-300 hover:bg-[#F5F3F8] transition-all duration-300 flex flex-col">
                    <div class="flex items-start gap-4 mb-4 flex-1">
                        ...
                        <div>
                            ...
                            <p class="text-gray-500 text-sm leading-relaxed">
                                Fixed stars are used in astrology to add specific, high-intensity, and often karmic, energetic nuances to natal charts, usually acting through close conjunctions with planets or angles like the Ascendant or Midheaven. Unlike planets, which signify personal or temporary, changing influences, these stationary stars provide enduring, often dramatic life themes, talents, or challenges.
                            </p>
                        </div>
                    </div>
                ...
                <div class="card-reveal card-link bg-white rounded-lg border border-gm-border p-6 hover:shadow-md hover:-translate-y-1 hover:border-gray-300 hover:bg-[#F5F3F8] transition-all duration-300 flex flex-col">
                    <div class="flex items-start gap-4 mb-4 flex-1">
                        ...
                        <div>
                            ...
                            <p class="text-gray-500 text-sm leading-relaxed">
                                Ayanamsha is the angular difference between the tropical zodiac (based on the seasons) and the sidereal zodiac (based on the fixed stars). It is also the "correction factor" used in Vedic astrology (Jyotish) to align the zodiac with the actual current positions of the stars, accounting for the precession of the equinoxes. Explore 50+ ayanamsha systems supported by Genetic Matrix, from Lahiri to custom.
                            </p>
                        </div>
                    </div>
                ...
                <div class="card-reveal card-link bg-white rounded-lg border border-gm-border p-6 hover:shadow-md hover:-translate-y-1 hover:border-gray-300 hover:bg-[#F5F3F8] transition-all duration-300 flex flex-col">
                    <div class="flex items-start gap-4 mb-4 flex-1">
                        <img src="assets/icon-synastry.svg" alt="Synastry" class="w-16 h-16 flex-shrink-0">
                        <div>
                            <h3 class="text-lg font-bold text-gray-800 mb-1">Synastry</h3>
                            <p class="text-gray-500 text-sm leading-relaxed">
                                Synastry is the branch of relationship astrology that compares two people's birth charts to determine their compatibility, strengths, and potential friction areas. It acts as a "cosmic map" that overlays one person's planets onto another's to show how their energies interact.
                            </p>
                        </div>
                    </div>
                    <a href="astrology/synastry.html" class="text-gm-purple text-sm font-semibold hover:underline mt-auto card-link-target">Explore →</a>
                </div>

                <!-- Progressions Card -->
                <div class="card-reveal card-link bg-white rounded-lg border border-gm-border p-6 hover:shadow-md hover:-translate-y-1 hover:border-gray-300 hover:bg-[#F5F3F8] transition-all duration-300 flex flex-col">
                    <div class="flex items-start gap-4 mb-4 flex-1">
                        <img src="assets/icon-progression.svg" alt="Progressions" class="w-16 h-16 flex-shrink-0">
                        <div>
                            <h3 class="text-lg font-bold text-gray-800 mb-1">Progressions</h3>
                            <p class="text-gray-500 text-sm leading-relaxed">
                                Astrological progressions are a technique used to forecast internal psychological development, personal evolution, and major life themes over time. Progressions represent how your birth chart evolves and matures from the inside out. Genetic Matrix supports Secondary Progressions and Solar Arc Directions.
                            </p>
                        </div>
                    </div>
                    <a href="astrology/progressions.html" class="text-gm-purple text-sm font-semibold hover:underline mt-auto card-link-target">Explore →</a>
                </div>

            </div>

            <h3 class="text-base md:text-lg font-semibold text-gray-700 mt-10 mb-5">Additional Astrology</h3>

            <!-- Additional Systems Cards Grid -->
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="card-reveal card-link bg-white rounded-lg border border-gm-border p-6 hover:shadow-md hover:-translate-y-1 hover:border-gray-300 hover:bg-[#F5F3F8] transition-all duration-300 flex flex-col">
                    <div class="flex items-start gap-4 mb-4 flex-1">
                        ...
                        <div>
                            ...
                            <p class="text-gray-500 text-sm leading-relaxed">
                                The Sabian Symbols are a set of 360 distinct, metaphorical images used in astrology to add deep, intuitive, and symbolic meaning to a birth chart or to act as an oracle for guidance. They represent a "living language" of images rather than rigid, technical rules.
                            </p>
                        </div>
                    </div>
                ...
                <!-- Charubel Degrees Card -->
                <div class="card-reveal card-link bg-white rounded-lg border border-gm-border p-6 hover:shadow-md hover:-translate-y-1 hover:border-gray-300 hover:bg-[#F5F3F8] transition-all duration-300 flex flex-col">
                    <div class="flex items-start gap-4 mb-4 flex-1">
                        <img src="assets/icon-charubel.svg" alt="Charubel Degrees" class="w-16 h-16 flex-shrink-0">
                        <div>
                            <h3 class="text-lg font-bold text-gray-800 mb-1">Charubel Degrees</h3>
                            <p class="text-gray-500 text-sm leading-relaxed">
                                Charubel Degrees are a set of 360 unique, often fatalistic, symbolic interpretations for each individual degree of the zodiac, developed by the 19th-century Welsh clairvoyant and astrologer John Thomas (under the pseudonym Charubel).
                            </p>
                        </div>
                    </div>
                    <a href="astrology/charubel-degrees.html" class="text-gm-purple text-sm font-semibold hover:underline mt-auto card-link-target">Explore →</a>
                </div>
                ...
                <div class="card-reveal card-link bg-white rounded-lg border border-gm-border p-6 hover:shadow-md hover:-translate-y-1 hover:border-gray-300 hover:bg-[#F5F3F8] transition-all duration-300 flex flex-col">
                    <div class="flex items-start gap-4 mb-4 flex-1">
                        ...
                        <div>
                            ...
                            <p class="text-gray-500 text-sm leading-relaxed">
                                Astrology and Tarot are linked as sister systems of divination that use shared archetypal symbols, elements, and cosmic energy to reveal, analyze, and map personal life paths. Astrology offers the overarching cosmic "map" of planetary movements, while Tarot provides the specific, detailed "design" for individual situations.
                            </p>
                        </div>
                    </div>
                ...
                <div class="card-reveal card-link bg-white rounded-lg border border-gm-border p-6 hover:shadow-md hover:-translate-y-1 hover:border-gray-300 hover:bg-[#F5F3F8] transition-all duration-300 flex flex-col">
                    <div class="flex items-start gap-4 mb-4 flex-1">
                        ...
                        <div>
                            ...
                            <p class="text-gray-500 text-sm leading-relaxed">
                                Chinese astrology is an ancient system based on a 12-year lunar cycle, where each year corresponds to an animal sign (Rat, Ox, Tiger, Rabbit, Dragon, Snake, Horse, Goat, Monkey, Rooster, Dog, Pig). It predicts personality and fate based on birth year, the five elements (wood, fire, earth, metal, water), and Yin/Yang, forming a 60-year cycle. Genetic Matrix integrates Chinese astrology with Western systems for a multi-system view.
                            </p>
                        </div>
                    </div>
                ...
                <div class="card-reveal card-link bg-white rounded-lg border border-gm-border p-6 hover:shadow-md hover:-translate-y-1 hover:border-gray-300 hover:bg-[#F5F3F8] transition-all duration-300 flex flex-col">
                    <div class="flex items-start gap-4 mb-4 flex-1">
                        <img src="assets/icon-vedic.svg" alt="Vedic Astrology" class="w-16 h-16 flex-shrink-0">
                        <div>
                            <h3 class="text-lg font-bold text-gray-800 mb-1">Vedic Astrology</h3>
                            <p class="text-gray-500 text-sm leading-relaxed">
                                Vedic Astrology, known in Sanskrit as Jyotish, is an ancient Indian system that maps the positions of stars and planets at the exact moment of a person's birth to understand their life path, personality, and karma. Unlike Western astrology, it uses the sidereal zodiac (aligned with actual constellations) and relies heavily on the Moon sign and 27 lunar mansions (Nakshatras). Genetic Matrix supports North Indian, South Indian, and Eastern chart styles and methods.
                            </p>
                        </div>
                    </div>
                    <a href="astrology/vedic.html" class="text-gm-purple text-sm font-semibold hover:underline mt-auto card-link-target">Explore →</a>
                </div>
