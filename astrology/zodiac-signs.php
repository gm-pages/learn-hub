...
<head>
 ...
 <link rel="canonical" href="https://geneticmatrix.com/learn/astrology/zodiac-signs/">
...
{"@context":"https://schema.org","@type":"Article","headline":"The 12 Zodiac Signs (Plus the 13th Sign) | Astrology Signs Explained","description":"Explore all 12 zodiac signs plus the controversial 13th sign Ophiuchus. Learn what each sign means, how planets express differently in each sign, and what it means to have planets in specific houses.","publisher":{"@type":"Organization","name":"Genetic Matrix","url":"https://geneticmatrix.com"},"mainEntityOfPage":"https://geneticmatrix.com/learn/astrology/zodiac-signs/"}
</script>
 <script type="application/ld+json">
...
<body class="bg-white text-gray-700">
 ...
 <!-- ==================== HERO BANNER ==================== -->
 <section class="relative overflow-hidden text-white text-center py-12 md:py-16" style="background: linear-gradient(135deg, #1e1240 0%, #3C2864 35%, #4a3070 55%, #3C2864 75%, #1a0e38 100%);">
     <!-- Milky Way band -->
     <div class="milky-way"></div>
     <!-- Star dots -->
     <div class="astro-stars"></div>
     <div class="max-w-3xl mx-auto px-6 relative z-10">
         <span class="inline-block bg-gm-purple text-white text-xs font-semibold tracking-widest uppercase px-4 py-1.5 rounded-full mb-4">Astrology</span>
         <h1 class="text-3xl md:text-4xl font-bold mb-3">The 12 Zodiac Signs (Plus the 13th Sign)</h1>
         <p class="text-gray-300 text-sm md:text-base leading-relaxed max-w-xl mx-auto">Explore all 12 zodiac signs plus the controversial 13th sign Ophiuchus. Learn what each sign means, how planets express differently in each sign, and what it means to have planets in specific houses.</p>
     </div>
 </section>
 ...
 <!-- ==================== THE 12 ZODIAC SIGNS ==================== -->
 <section class="py-10 md:py-14 bg-gm-light relative overflow-hidden" id="the-12-zodiac-signs">
     <!-- Background zodiac wheel -->
     <div class="absolute inset-0 flex items-center justify-center pointer-events-none">
         <svg class="w-[800px] h-[800px] opacity-[0.04]" viewBox="0 0 400 400" fill="none" stroke="#6E5898" stroke-width="0.8" style="animation: slowSpin 120s linear infinite;">
             <!-- Outer circle -->
             ...
             <line x1="295" y1="52.7" x2="262.5" y2="82.7"/>
             <line x1="347.3" y1="105" x2="317.3" y2="130"/>
             <line x1="390" y1="200" x2="340" y2="200"/>
             <line x1="347.3" y1="295" x2="317.3" y2="270"/>
             <line x1="295" y1="347.3" x2="262.5" y2="317.3"/>
             <line x1="200" y1="390" x2="200" y2="340"/>
             <line x1="105" y1="347.3" x2="137.5" y2="317.3"/>
             <line x1="52.7" y1="295" x2="82.7" y2="270"/>
             <line x1="10" y1="200" x2="60" y2="200"/>
             <line x1="52.7" y1="105" x2="82.7" y2="130"/>
             <line x1="105" y1="52.7" x2="137.5" y2="82.7"/>
             <!-- Small sign marks on outer ring -->
             <circle cx="200" cy="25" r="4"/>
             <circle cx="290" cy="58" r="4"/>
             <circle cx="342" cy="110" r="4"/>
             <circle cx="375" cy="200" r="4"/>
             <circle cx="342" cy="290" r="4"/>
             <circle cx="290" cy="342" r="4"/>
             <circle cx="200" cy="375" r="4"/>
             <circle cx="110" cy="342" r="4"/>
             <circle cx="58" cy="290" r="4"/>
             <circle cx="25" cy="200" r="4"/>
     ...
     <div class="max-w-4xl mx-auto px-6 relative z-10">
         ...
         <h3 class="text-lg font-semibold text-gray-800 mt-8 mb-3 flex items-center gap-3">
             <svg class="w-7 h-7 flex-shrink-0" viewBox="0 0 24 24" fill="none" stroke="#6E5898" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
                 <path d="M5 18C5 12 8 6 12 3c4 3 7 9 7 15"/>
                 <path d="M12 3v18"/>
             </svg>
         ...
         <p class="text-gm-text text-sm md:text-base leading-relaxed mb-4">Gemini is the sign of communication, curiosity, and mental agility. Gemini energy wants to learn everything, talk to everyone, and juggle multiple interests simultaneously. It is adaptable, witty, and socially versatile. At its most challenging, Gemini can be superficial, inconsistent, and scattered. Gemini rules the hands, arms, and lungs.</p>

         <h3 class="text-lg font-semibold text-gray-800 mt-8 mb-3 flex items-center gap-3">
             <svg class="w-7 h-7 flex-shrink-0" viewBox="0 0 24 24" fill="none" stroke="#6E5898" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
                 <circle cx="7" cy="9" r="3"/>
                 <circle cx="17" cy="15" r="3"/>
                 <path d="M10 9c4 0 10 0 10 6"/>
                 <path d="M14 15c-4 0-10 0-10-6"/>
             </svg>
         ...
         <p class="text-gm-text text-sm md:text-base leading-relaxed mb-4">Libra is the sign of balance, partnership, and aesthetic harmony. Libra energy seeks fairness, beauty, and meaningful one-to-one connection. It is diplomatic, charming, and socially graceful. At its most challenging, Libra can be indecisive, people-pleasing, and conflict-avoidant to the point of dishonesty. Libra rules the kidneys, lower back, and skin.</p>

         <h3 class="text-lg font-semibold text-gray-800 mt-8 mb-3 flex items-center gap-3">
             <svg class="w-7 h-7 flex-shrink-0" viewBox="0 0 24 24" fill="none" stroke="#6E5898" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
                 <path d="M4 4v12c0 2 1 4 3 4"/>
                 <path d="M4 10h0c0-4 4-6 4-6v12c0 2 1 4 3 4"/>
                 <path d="M8 10h0c0-4 4-6 4-6v12c0 2 1 4 3 4h1"/>
                 <path d="M17 17l3 3m0 0l-2-1m2 1l-1-2"/>
             </svg>
         ...
         <p class="text-gm-text text-sm md:text-base leading-relaxed mb-4">Aquarius is the sign of innovation, humanitarianism, and individual freedom within the collective. Aquarius energy is progressive, intellectual, and often ahead of its time. It values independence, originality, and social causes. At its most challenging, Aquarius can be emotionally detached, contrarian, and aloof. Aquarius rules the ankles and circulatory system.</p>

         <h3 class="text-lg font-semibold text-gray-800 mt-8 mb-3 flex items-center gap-3">
             <svg class="w-7 h-7 flex-shrink-0" viewBox="0 0 24 24" fill="none" stroke="#6E5898" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
                 <path d="M6 4c4 4 4 12 0 16"/>
                 <path d="M18 4c-4 4-4 12 0 16"/>
                 <path d="M4 12h16"/>
             </svg>
 ...
 <section class="py-10 md:py-14 bg-white">
     <div class="max-w-4xl mx-auto px-6">
         ...
         <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
             ...
             <a href="houses.html" class="bg-gm-light rounded-lg border border-gm-border p-4 hover:shadow-md transition">
             ...
             <a href="aspects.html" class="bg-gm-light rounded-lg border border-gm-border p-4 hover:shadow-md transition">
             ...
             <a href="asteroids.html" class="bg-gm-light rounded-lg border border-gm-border p-4 hover:shadow-md transition">
             ...
             <a href="fixed-stars.html" class="bg-gm-light rounded-lg border border-gm-border p-4 hover:shadow-md transition">
